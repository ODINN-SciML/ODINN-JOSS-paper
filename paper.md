...
- Model parameters (e.g. the Glen coefficient `A` related to ice viscocity in a 2D Shallow Ice Approximation [@hutter_theoretical_1983]), in a gridded or scalar format. This can be done for multiple time steps where observations (e.g. ice surface velocities) are available.
